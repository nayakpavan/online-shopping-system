...
public class eraserbuyframe extends JFrame {

public static void main(String[] args) {
eraserbuyframe frameTabel = new eraserbuyframe();
}

JLabel eraser = new JLabel("PAYMENT:");
...
eraser.setBounds(250,50,200,80);
...
if(na.equals("nayak") && ca.equals("58890") &&ad.equals("MIT Manipal-576104"))
 {
     eraserpayframe regFace =new eraserpayframe();
