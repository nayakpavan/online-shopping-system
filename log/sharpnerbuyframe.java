...
public class sharpnerbuyframe extends JFrame {

public static void main(String[] args) {
sharpnerbuyframe frameTabel = new sharpnerbuyframe();
}

JLabel sharpner = new JLabel("PAYMENT:");
...
sharpner.setBounds(250,50,200,80);
...
public void actioncancelorder()
{
    p.addActionListener(new ActionListener()
    {
        ...
        {
                dispose();
                sharpnerframe f=new sharpnerframe();
                f.setVisible(true);
...
if(na.equals("nayak") && ca.equals("58890") &&ad.equals("MIT Manipal-576104"))
 {
     sharpnerpayframe regFace =new sharpnerpayframe();
