...
public class sharpnerframe extends JFrame {

public static void main(String[] args) {
sharpnerframe frameTabel = new sharpnerframe();
}
JLabel sharpners = new JLabel("SHARPNERSS:");
JLabel rup = new JLabel("(Rs.5 per sharpner)");
...
sharpners.setBounds(250,50,200,80);
rup.setBounds(250,90,150,50);
