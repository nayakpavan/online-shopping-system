...
public class penbuyframe extends JFrame {

public static void main(String[] args) {
penbuyframe frameTabel = new penbuyframe();
}

JLabel pens = new JLabel("PAYMENT:");
...
if(na.equals("nayak") && ca.equals("58890") &&ad.equals("MIT Manipal-576104"))
 {
     penpayframe regFace =new penpayframe();
