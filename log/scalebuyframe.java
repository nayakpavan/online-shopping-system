...
public class scalebuyframe extends JFrame {

public static void main(String[] args) {
scalebuyframe frameTabel = new scalebuyframe();
}

JLabel scale = new JLabel("PAYMENT:");
...
if(na.equals("nayak") && ca.equals("58890") &&ad.equals("MIT Manipal-576104"))
 {
     scalepayframe regFace =new scalepayframe();
